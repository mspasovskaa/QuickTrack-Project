...
namespace ProektSept.Controllers
{
    ...
    public class TransportsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Type,Price")] Transport transport)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Type,Price")] Transport transport)
        {
            if (ModelState.IsValid)
            {
